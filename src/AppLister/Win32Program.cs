...
using AppLister.FileSystemHelper;
using AppLister.Native;
using AppLister.Utils;
using Microsoft.Win32;
using DirectoryWrapper = AppLister.FileSystemHelper.DirectoryWrapper;
...
public class Win32Program : IProgram
{
    ...
    public static IDirectoryWrapper DirectoryWrapper { get; set; } = new FileSystemHelper.DirectoryWrapper();
    ...
    private string GetSubtitle()
    {
        switch (AppType)
        {
            ...
            case ApplicationType.InternetShortcutApplication:
                return "Internet shortcut application";
